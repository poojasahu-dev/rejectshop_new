 ...
 *  
 */
package au.com.rejectshop.errors.converters;
...
public class CartModificationDataErrorConverterTest
{
	...
	public void testConvertWhenOutOfStock()
	{
		...
		final List<de.hybris.platform.webservicescommons.dto.error.ErrorWsDTO> result = cartModificationDataErrorConverter.convert(cartModificationData);

		Assert.assertEquals(1, result.size());
		final de.hybris.platform.webservicescommons.dto.error.ErrorWsDTO error = result.get(0);
