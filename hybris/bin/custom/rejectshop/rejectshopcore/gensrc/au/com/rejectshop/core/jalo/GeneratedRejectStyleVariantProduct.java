...
/**
 * Generated class for type {@link au.com.rejectshop.core.jalo.RejectStyleVariantProduct RejectStyleVariantProduct}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedRejectStyleVariantProduct extends VariantProduct
{
	/** Qualifier of the <code>RejectStyleVariantProduct.style</code> attribute **/
	public static final String STYLE = "style";
	/** Qualifier of the <code>RejectStyleVariantProduct.swatchColors</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>RejectStyleVariantProduct.style</code> attribute.
	...
	public String getStyle(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedRejectStyleVariantProduct.getStyle requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>RejectStyleVariantProduct.style</code> attribute. 
	...
	public void setStyle(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedRejectStyleVariantProduct.setStyle requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>RejectStyleVariantProduct.swatchColors</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>RejectStyleVariantProduct.swatchColors</code> attribute. 
