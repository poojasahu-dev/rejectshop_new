...
/**
 * Generated class for type {@link au.com.rejectshop.core.jalo.RejectSizeVariantProduct RejectSizeVariantProduct}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedRejectSizeVariantProduct extends VariantProduct
{
	/** Qualifier of the <code>RejectSizeVariantProduct.size</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>RejectSizeVariantProduct.size</code> attribute.
	...
	public String getSize(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedRejectSizeVariantProduct.getSize requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>RejectSizeVariantProduct.size</code> attribute. 
	...
	public void setSize(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedRejectSizeVariantProduct.setSize requires a session language", 0 );
		}
