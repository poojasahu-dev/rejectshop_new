 ...
 *
 */
package au.com.rejectshop.core.strategies.impl;
 ...
 */
public class RejectSizeProductReferenceTargetStrategy implements ProductReferenceTargetStrategy
{
	...
	{
		if (sourceProduct instanceof RejectSizeVariantProductModel
				&& reference.getTarget() instanceof RejectSizeVariantProductModel)
		{
			...
			if (CollectionUtils.containsAny(sourceSuperCategories, targetSuperCategories))
			{
				...
				final String size = ((RejectSizeVariantProductModel) sourceProduct).getSize();
				for (final VariantProductModel variant : reference.getTarget().getVariants())
				{
					if (variant instanceof RejectSizeVariantProductModel
							&& size.equals(((RejectSizeVariantProductModel) variant).getSize()))
					{
						return variant;
					}
				}
