 ...
 *  
 */
package au.com.rejectshop.core.hmc;
...
/**
 * Provides necessary meta information about the rejectshopcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class RejectshopCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(RejectshopCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "au.com.rejectshop.core.hmc.locales";
