ACC.ratingstars = {
	...
	bindRatingStarsSet: function(){
		...
		$e.on("mouseenter touchstart",".js-rationIconSet",function(e){
			e.preventDefault();
		...
		$(document).on("mouseleave touchend",".js-ratingCalcSet",function(e){
			e.preventDefault();
		...
		$e.on("click touchstart",".js-rationIconSet",function(e){
			e.preventDefault();
			var cindex =  $(this).index()+1;
			/*var ratingData = $e.data("rating");
			var cindex =  $(this).index()+1;
			ratingData.rating = cindex/2
			$(".js-ratingSetInput").val(ratingData.rating)*/
			var ratingValue = $(".rating-stars").attr("data-rate-value");
