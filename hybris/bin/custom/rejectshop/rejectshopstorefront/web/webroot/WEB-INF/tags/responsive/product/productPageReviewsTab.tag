...
<div class="tab-review">
	<div class="review-pagination-bar">
			<button onclick='tealiumTagEvent("writeReview")' class="btn btn-default js-review-write-toggle "><spring:theme code="review.write.title"/></button>
	...
	<div class="write-review js-review-write">
		<form:form method="post" action="${productReviewActionUrl}" commandName="reviewForm" onsubmit='tealiumTagEvent("reviewSubmit")'>
			...
			<input type="submit" class="btn btn-primary" value="<spring:theme code="review.submit"/>" />
		</form:form>
