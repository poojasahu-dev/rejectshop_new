	...
	<%-- <c:choose> --%>
		...
		<%-- <c:otherwise> --%>
			<ycommerce:testId code="addToCartButton">
				...
				<button id="addToCartButton" onclick="tealiumTagEvent('addToCart','${product.code}','${product.name}','${product.price.value}')" type="${buttonType}" class="addToCartClassButton">
				<img class="icon icons8-Add-List" src="${commonResourcePath}/images/carticon.png" width="30" height="30">		<spring:theme code="basket.add.to.basket"/>
				</button>				
			</ycommerce:testId>
