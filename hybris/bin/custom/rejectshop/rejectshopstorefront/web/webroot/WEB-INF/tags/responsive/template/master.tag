...
<link rel="shortcut icon" type="image/x-icon" media="all" href="${themeResourcePath}/images/favicon.ico" />
	...
	<c:if test="${pageType == 'HOMEPAGE'}">
		<meta name="google-site-verification" content="gSN2bgYJbFmefIngXRmhZBKTlqVhc-89H_nYLm9qnJM" />
	</c:if>
</head>
