...
function trackPublicNoticeClick() {
	_gaq.push(['_trackEvent', 'publicNoticeClick', 'publicNoticeClick']);
}


window.mediator.subscribe('publicNoticeClick', function(data) {
		trackPublicNoticeClick();
});
