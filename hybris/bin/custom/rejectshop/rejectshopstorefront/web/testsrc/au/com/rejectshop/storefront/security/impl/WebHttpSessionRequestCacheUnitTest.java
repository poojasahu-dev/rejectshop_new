...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/rejectshopstorefront/electronics/en",
						"https://electronics.local:9002/rejectshopstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/rejectshopstorefront/electronics/en",
						"https://electronics.local:9002/rejectshopstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/rejectshopstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/rejectshopstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/rejectshopstorefront/electronics/en",
						"https://electronics.local:9002/rejectshopstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/rejectshopstorefront",
						"https://electronics.local:9002/rejectshopstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/rejectshopstorefront",
						"https://electronics.local:9002/rejectshopstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/rejectshopstorefront/electronics/en",
						"https://electronics.local:9002/rejectshopstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
