 ...
 *
 */
package au.com.rejectshop.storefront.controllers.pages.checkout.steps;
...
public class SopPaymentResponseController extends PaymentMethodCheckoutStepController
{
	...
	@RequireHardLogIn
	public @ResponseBody String doHandleSopResponse(final HttpServletRequest request, @Valid
	final SopPaymentDetailsForm sopPaymentDetailsForm,
	...
	@ResponseStatus(value = HttpStatus.OK)
	@RequireHardLogIn
	public @ResponseBody String doHandleSopResponseGet(final HttpServletRequest request, @Valid
