 ...
 *
 */
package au.com.rejectshop.storefront.payment.controllers;
...
import au.com.rejectshop.storefront.payment.validation.TRSSopPaymentDetailsValidator;


@Controller
@RequestMapping("/sop-mock")
public class TRSSilentOrderPostMockController
{
	protected static final Logger LOG = Logger.getLogger(TRSSilentOrderPostMockController.class);
	...
	@Resource(name = "trsSOPPaymentDetailsValidator")
	private TRSSopPaymentDetailsValidator trsSOPPaymentDetailsValidator;

	/**
	 * @return the trsSOPPaymentDetailsValidator
	 */
	public TRSSopPaymentDetailsValidator getTrsSOPPaymentDetailsValidator()
	{
		return trsSOPPaymentDetailsValidator;
	}
	...
	public String doValidateAndPost(@Valid final TRSSopPaymentDetailsForm form, final BindingResult bindingResult,
			final HttpServletRequest request, final Model model)
	{
		...
		getTrsSOPPaymentDetailsValidator().validate(form, bindingResult);
