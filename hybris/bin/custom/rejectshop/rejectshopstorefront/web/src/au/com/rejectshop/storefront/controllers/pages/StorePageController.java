...
import au.com.rejectshop.storefront.breadcrumb.impl.StoreBreadcrumbBuilder;
...
public class StorePageController extends AbstractPageController
{
			...
			final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
		...
		if (sourceLatitude != null && sourceLongitude != null)
		{
			...
			try
			{
				pointOfServiceData = storeFinderFacade.getPointOfServiceForNameAndPosition(storeCode,
						geoPoint);
				...
				model.addAttribute("pageType", PageType.STOREDETAILPAGE.name());
		...
		else
		{
			...
			try
			{
				pointOfServiceData = storeFinderFacade.getPointOfServiceForName(storeCode);
				pointOfServiceData.setUrl(STORE_URL + pointOfServiceData.getName());
				model.addAttribute(STORE_ATTR, pointOfServiceData);
