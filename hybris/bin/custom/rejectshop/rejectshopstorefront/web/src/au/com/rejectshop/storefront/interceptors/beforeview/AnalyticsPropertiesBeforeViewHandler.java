 ...
 *
 */
package au.com.rejectshop.storefront.interceptors.beforeview;
...
public class AnalyticsPropertiesBeforeViewHandler implements BeforeViewHandler
{
	...
	private static final String TEALIUM_PREFIX = "tealium";
	private static final String TEALIUM_ACCOUNT = "tealiumAccount";
	private static final String TEALIUM_PROFILE = "tealiumProfile";
	private static final String TEALIUM_ENV = "tealiumEnvironment";
	...
	public void beforeView(final HttpServletRequest request, final HttpServletResponse response, final ModelAndView modelAndView)
	{
		...
		addHostProperty(serverName, modelAndView, WebConstants.TEALIUM_UTAG_ACCOUNT, TEALIUM_ACCOUNT);
		addHostProperty(serverName, modelAndView, WebConstants.TEALIUM_UTAG_PROFILE, TEALIUM_PROFILE);
		addHostProperty(serverName, modelAndView, WebConstants.TEALIUM_UTAG_ENV, TEALIUM_ENV);
	...
	protected class ConfigChangeListener implements ConfigIntf.ConfigChangeListener
	{
		...
		public void configChanged(final String key, final String newValue)
		{
			...
			if (key.startsWith(JIRAFE_PREFIX) || key.startsWith(GOOGLE_PREFIX) || key.startsWith(TEALIUM_PREFIX))
			{
