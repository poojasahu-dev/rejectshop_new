 ...
 *
 */
package au.com.rejectshop.storefront.breadcrumb.impl;
...
import au.com.rejectshop.storefront.breadcrumb.Breadcrumb;
...
public class StoreBreadcrumbBuilder
{
	...
	public List<Breadcrumb> getBreadcrumbs(final PointOfServiceData pointOfServiceData, final String storeFinderUrl)
	{
		...
		breadcrumbs.add(new Breadcrumb("#", pointOfServiceData.getDisplayName(), null));
	...
	public List<Breadcrumb> getBreadcrumbsForSubPage(final PointOfServiceData pointOfServiceData, final String pageResourceKey)
	{
		...
		final String storePageUrl = "/store/" + pointOfServiceData.getDisplayName();
		breadcrumbs.add(new Breadcrumb(storePageUrl, pointOfServiceData.getDisplayName(), null));
