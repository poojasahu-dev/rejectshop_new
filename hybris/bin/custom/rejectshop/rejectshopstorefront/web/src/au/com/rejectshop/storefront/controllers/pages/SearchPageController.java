...
public class SearchPageController extends AbstractSearchPageController
{
			...
			final HttpServletRequest request, final Model model) throws CMSItemNotFoundException
	{
		if (StringUtils.isNotBlank(searchText))
		{
			...
			if (searchPageData != null)
			{
				...
				setupPromoPrice(searchPageData.getResults());
			}
			...
			@RequestParam("term") final String term) throws CMSItemNotFoundException
	{
		...
		if (component.isDisplayProducts())
		{
			...
			setupPromoPrice(resultData.getProducts());
		}
	...
	/* Function used to setup and call setPricePromotionData function to get the future price set in the price data */
	protected void setupPromoPrice(final List<ProductData> productResults)
	{
		//final List<ProductData> listProductData = searchPageData.getResults();
		for (final ProductData productData : productResults)
		{
