...
public class SeoRobotsFollowBeforeViewHandler implements BeforeViewHandler
{
	...
	private static final Logger LOG = Logger.getLogger(SeoRobotsFollowBeforeViewHandler.class);
	@Override
	public void beforeView(final HttpServletRequest request, final HttpServletResponse response, final ModelAndView modelAndView)
	{
		...
		if (modelAndView != null && !modelAndView.getModel().containsKey(ThirdPartyConstants.SeoRobots.META_ROBOTS))
		{
			...
			//LOG.info("inside this  request method"+request.getMethod()+"----is request secured "+request.isSecure());
