...
<%-- plugins --%>
<script type="text/javascript" src="${commonResourcePath}/js/lightbox-plus-jquery.min.js"></script>
...
<%-- Custom ACC JS --%>
<%-- <script type="text/javascript" src="${commonResourcePath}/js/jquery.zoom.js"></script> --%>
<script type="text/javascript" src="${commonResourcePath}/js/rater.js"></script>
...
<script type="text/javascript" src="${commonResourcePath}/js/jquery.elevateZoom-3.0.8.min.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/easyzoom.js"></script>
<%-- <script type="text/javascript" src="${commonResourcePath}/js/jzoom.js"></script> --%>
...
<script type="text/javascript" src="${commonResourcePath}/js/jquery.firstVisitPopup.js"></script>


<script type="text/javascript" src="${commonResourcePath}/js/_autoload.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/picturefill.js"></script>
...
<script type="text/javascript" src="${commonResourcePath}/js/jssor.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/jssor.slider.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/acc.roatingbanner.js"></script>