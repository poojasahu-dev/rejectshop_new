...
<template:page pageTitle="${pageTitle}" hideHeaderLinks="true">
	...
	<div class="span-14 append-1">
		<div id="checkoutContentPanel" class="clearfix">
			...
			<div class="description"><p><spring:theme code="checkout.multi.selectDeliveryMethodMessage"/></p></div>hihi
			HIHI
	...
	<input type="radio" name="delivery_method" id="free-standard-shipping" value="free-standard-shipping"/>
	<label for="free-standard-shipping">free-standard-shipping &nbsp;-&nbsp;free-standard-shipping &nbsp;-&nbsp;0</label>
</li>
