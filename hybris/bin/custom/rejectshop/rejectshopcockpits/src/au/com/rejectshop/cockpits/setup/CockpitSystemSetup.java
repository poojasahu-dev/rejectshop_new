 ...
 *  
 */
package au.com.rejectshop.cockpits.setup;
...
import au.com.rejectshop.cockpits.constants.RejectshopCockpitsConstants;
 ...
 */
@SystemSetup(extension = RejectshopCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(RejectshopCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(RejectshopCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						RejectshopCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/rejectshopcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
