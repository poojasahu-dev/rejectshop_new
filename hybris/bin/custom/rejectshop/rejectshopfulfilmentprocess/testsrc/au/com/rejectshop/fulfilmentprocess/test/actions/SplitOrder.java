 ...
 *  
 */
package au.com.rejectshop.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(RejectshopFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(RejectshopFulfilmentProcessConstants.PARENT_PROCESS);
