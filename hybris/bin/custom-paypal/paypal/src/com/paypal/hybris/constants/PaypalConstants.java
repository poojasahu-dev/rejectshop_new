...
public final class PaypalConstants extends GeneratedPaypalConstants
{
	...
	// Env Settings
	public static final String PAYPAL_ENV_PROFILE = "paypal.environment";
	public static final String PP_PREFIX = "paypal.";
	...
	public static final String REDIRECT_URL_REPEAT_ORDER = ".redirectUrl.repeat.order.";


	public static final String PAYPAL_GUEST_REDIRECT = "paypal.store.login.required";
	...
	public static final String DEFAULT_PAYMENT_ACTION_NAME = AUTHORIZATION_PAYMENT_ACTION_NAME;
	...
	public static final String PAYPAL_CURRENCY_INTEGER = "HUF|JPY|TWD";
	public static final String PAYPAL_AMOUNT_FORMAT_INTEGER = "0";
	public static final String PAYPAL_AMOUNT_FORMAT_DECIMAL = "0.00";
	...
	public static final String BUTTON_SOURCE = "paypal.button.source";
	public static final String PAYPAL_KEY = "paypal.value.strong.button.source.key";
...
//	public static final String USE_REFERENCE_TRANSCATION = "paypal.useReferenceTransaction";
	...
	//order process
	public static final String ORDER_PROCESS_RESTART_NODE = "paypal.order.process.restart.node";
	...
	public static final String ORDER_PROCESS_ACTION_WAITFORTAKEPAYMENT = "waitForTakePayment";
	public static final String EVENT_CONTINUE_ORDER_WITH_CHOICE = "_event_ContinueOrder_WithChoice";

	public static final String PAY_PAL_REPEAT_REDIRECT_URL = "payPalRepeateRedirectUrl";
	public static final String PAY_PAL_DELIVERY_MODE = "paypal";

	public static final String PAY_PAL_REPLENISHMENT_CAPTURE = "REPLENISHMENT";
	public static final String DEFAULT_CATALOG_VERSION = "Default";
	public static final String CATALOG_NAME = "paypal.catalog.name";
	public static final String PAYPAL_FLOW = "payPalFlow";
	public static final String SIMPLE_FLOW = "simpleFlow";
	public static final String MARK_FLOW = "markFlow";
	public static final String REPLENISHMENT_FLOW = "replenishment";
