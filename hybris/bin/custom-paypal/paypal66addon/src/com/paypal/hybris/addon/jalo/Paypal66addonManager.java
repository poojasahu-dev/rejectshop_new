...
/**
 * This is the extension manager of the Paypal66addon extension.
 */
public class Paypal66addonManager extends GeneratedPaypal66addonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Paypal66addonManager.class.getName());
	 ...
	 */
	public static Paypal66addonManager getInstance()
	{
		return (Paypal66addonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Paypal66addonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Paypal66addonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Paypal66addonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Paypal66addonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Paypal66addonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
