...
@Scope("tenant")
@RequestMapping(value = Paypal66addonControllerConstants.Actions.Cms.PayPalMiniCartComponent)
public class PayPalECMiniCartComponentController extends AbstractCMSAddOnComponentController<PayPalECMiniCartComponentModel> {
