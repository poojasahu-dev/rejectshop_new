...
public class PayPalMiniCartController extends AbstractController
{
	...
	public String rolloverMiniCartPopup(@PathVariable final String componentUid, final Model model) throws CMSItemNotFoundException
	{
		...
		final PayPalECMiniCartComponentModel component = (PayPalECMiniCartComponentModel) cmsComponentService
		...
		model.addAttribute("payPalECButtonComponent", component.getPayPalECButtonComponent());

		return Paypal66addonControllerConstants.Views.Fragments.Cart.CartPopup;
	}
}
