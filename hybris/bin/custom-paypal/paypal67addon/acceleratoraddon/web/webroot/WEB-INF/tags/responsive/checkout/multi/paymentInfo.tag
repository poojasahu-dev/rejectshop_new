            ...
            <div class="address">
                <c:choose>
                    <c:when test="${paymentInfo.cardType eq 'PAYPAL PAYMENT'}">
                        ...
                        <br><div class="pp-account-email">${fn:escapeXml(paymentInfo.subscriptionId)}</div>
                    </c:when>
                    <c:when test="${paymentInfo.cardType eq 'PAYPAL CREDIT PAYMENT'}">
                        <img
                                ...
                                alt="PayPal icon" />
                        <spring:theme code="paymentMethod.type" />
                        <br><div class="pp-account-email credit">${fn:escapeXml(paymentInfo.subscriptionId)}</div>
                    </c:when>
                    <c:otherwise>
