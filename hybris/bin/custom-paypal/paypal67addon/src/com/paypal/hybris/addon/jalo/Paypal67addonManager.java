...
/**
 * This is the extension manager of the Paypal67addon extension.
 */
public class Paypal67addonManager extends GeneratedPaypal67addonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Paypal67addonManager.class.getName());
	 ...
	 */
	public static Paypal67addonManager getInstance()
	{
		return (Paypal67addonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Paypal67addonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Paypal67addonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Paypal67addonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Paypal67addonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Paypal67addonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
