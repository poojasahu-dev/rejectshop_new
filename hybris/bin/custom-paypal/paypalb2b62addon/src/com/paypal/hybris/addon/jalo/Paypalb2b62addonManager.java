...
/**
 * This is the extension manager of the Paypalb2b62addon extension.
 */
public class Paypalb2b62addonManager extends GeneratedPaypalb2b62addonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Paypalb2b62addonManager.class.getName());
	 ...
	 */
	public static Paypalb2b62addonManager getInstance()
	{
		return (Paypalb2b62addonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Paypalb2b62addonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Paypalb2b62addonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Paypalb2b62addonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Paypalb2b62addonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Paypalb2b62addonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
