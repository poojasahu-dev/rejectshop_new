...
public class PayPalCreatePaymentController extends AbstractCheckoutController {
    ...
    public TokenResponse paymentEC(final Model model) {
        ...
        return prepareExpressCheckout(model, "/paypal/checkout/payment/reauthorize/response", "/cart", PaypalConstants.CREDIT_CARD,
    ...
    public TokenResponse markEC(final Model model) {
        ...
        return prepareExpressCheckout(model, "/paypal/checkout/payment/reauthorize/response", "/checkout/multi/payment-method/add",
    ...
    private void handleErrors(final AbstractResultData resultData) {
        ...
        getSessionService().setAttribute(Paypalb2b62addonControllerConstants.PAY_PAL_ERRORS_DETAILS, errorCodeToMsgMap);
    ...
    private String getPayPalErrorMessage() {
        Map<String, String> payPalErrors = (Map<String, String>) getSessionService().getAttribute(Paypalb2b62addonControllerConstants.PAY_PAL_ERRORS_DETAILS);
