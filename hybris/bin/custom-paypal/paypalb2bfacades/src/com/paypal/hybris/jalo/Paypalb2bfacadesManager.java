...
/**
 * This is the extension manager of the Paypalb2bfacades extension.
 */
public class Paypalb2bfacadesManager extends GeneratedPaypalb2bfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Paypalb2bfacadesManager.class.getName());
	 ...
	 */
	public static Paypalb2bfacadesManager getInstance()
	{
		return (Paypalb2bfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Paypalb2bfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Paypalb2bfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Paypalb2bfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Paypalb2bfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Paypalb2bfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
