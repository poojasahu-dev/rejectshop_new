...
import com.paypal.hybris.constants.PaypalacceleratorfacadesConstants;



/**
 * This is the extension manager of the Paypalacceleratorfacades extension.
 */
public class PaypalacceleratorfacadesManager extends GeneratedPaypalacceleratorfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PaypalacceleratorfacadesManager.class.getName());
	 ...
	 */
	public static PaypalacceleratorfacadesManager getInstance()
	{
		return (PaypalacceleratorfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				PaypalacceleratorfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PaypalacceleratorfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PaypalacceleratorfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PaypalacceleratorfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of PaypalacceleratorfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
