...
/**
 * This is the extension manager of the Paypalfacades extension.
 */
public class PaypalfacadesManager extends GeneratedPaypalfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PaypalfacadesManager.class.getName());
	 ...
	 */
	public static PaypalfacadesManager getInstance()
	{
		return (PaypalfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				PaypalfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PaypalfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PaypalfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PaypalfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of PaypalfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
