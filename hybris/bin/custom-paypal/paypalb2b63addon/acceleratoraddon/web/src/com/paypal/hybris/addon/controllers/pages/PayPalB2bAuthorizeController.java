...
@RestController
@RequestMapping(value = "/paypal/b2b/checkout/payment/authorize")
public class PayPalB2bAuthorizeController extends AbstractPageController
{

	private static final Logger LOG = Logger.getLogger(PayPalB2bAuthorizeController.class);
	...
	private void handleErrors(final AbstractResultData resultData) {
		...
		getSessionService().setAttribute(Paypalb2b63addonControllerConstants.PAY_PAL_ERRORS_DETAILS, errorCodeToMsgMap);
