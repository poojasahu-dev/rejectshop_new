...
@Scope("tenant")
@RequestMapping(value = Paypalb2b63addonControllerConstants.Actions.Cms.PayPalMiniCartComponent)
public class PayPalB2bMiniCartComponentController extends AbstractCMSAddOnComponentController<PayPalB2bECMiniCartComponentModel>
{
