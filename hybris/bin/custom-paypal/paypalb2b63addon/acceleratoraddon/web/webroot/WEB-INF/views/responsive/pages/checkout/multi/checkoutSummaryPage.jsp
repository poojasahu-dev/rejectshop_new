...
<%@ taglib prefix="multi-checkout-paypal" tagdir="/WEB-INF/tags/addons/paypalb2b63addon/responsive/checkout/multi" %>

<spring:url value="/checkout/multi/summary/placeOrder" var="placeOrderUrl"/>
<spring:url value="/checkout/multi/termsAndConditions" var="getTermsAndConditionsUrl"/>
<spring:url value="/paypal/replenishment/error" var="replenishmentErrorUrl"/>
