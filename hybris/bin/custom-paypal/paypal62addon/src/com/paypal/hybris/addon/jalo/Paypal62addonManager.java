...
/**
 * This is the extension manager of the Paypal62addon extension.
 */
public class Paypal62addonManager extends GeneratedPaypal62addonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Paypal62addonManager.class.getName());
	 ...
	 */
	public static Paypal62addonManager getInstance()
	{
		return (Paypal62addonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Paypal62addonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Paypal62addonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Paypal62addonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Paypal62addonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Paypal62addonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
