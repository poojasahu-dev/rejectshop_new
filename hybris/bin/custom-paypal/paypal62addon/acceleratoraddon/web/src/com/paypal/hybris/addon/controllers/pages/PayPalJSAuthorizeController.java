...
public class PayPalJSAuthorizeController extends AbstractPageController
{

	private static final Logger LOG = Logger.getLogger(PayPalJSAuthorizeController.class.getName());
