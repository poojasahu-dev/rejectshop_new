...
/**
 * This is the extension manager of the Paypal60addon extension.
 */
public class Paypal60addonManager extends GeneratedPaypal60addonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Paypal60addonManager.class.getName());
	 ...
	 */
	public static Paypal60addonManager getInstance()
	{
		return (Paypal60addonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Paypal60addonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Paypal60addonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Paypal60addonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Paypal60addonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Paypal60addonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
