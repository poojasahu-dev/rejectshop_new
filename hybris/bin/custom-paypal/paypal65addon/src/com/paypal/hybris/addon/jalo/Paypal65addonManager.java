...
/**
 * This is the extension manager of the Paypal65addon extension.
 */
public class Paypal65addonManager extends GeneratedPaypal65addonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Paypal65addonManager.class.getName());
	 ...
	 */
	public static Paypal65addonManager getInstance()
	{
		return (Paypal65addonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Paypal65addonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Paypal65addonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Paypal65addonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Paypal65addonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Paypal65addonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
