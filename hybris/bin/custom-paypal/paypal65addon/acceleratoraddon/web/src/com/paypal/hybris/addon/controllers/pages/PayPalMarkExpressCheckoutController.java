...
public class PayPalMarkExpressCheckoutController extends AbstractCheckoutController {
    ...
    private String getPayPalErrorMessage() {
        Map<String, String> payPalErrors = (Map<String, String>) getSessionService().getAttribute(Paypal65addonControllerConstants.PAY_PAL_ERRORS_DETAILS);
    ...
    private void handleErrors(final AbstractResultData resultData) {
        ...
        getSessionService().setAttribute(Paypal65addonControllerConstants.PAY_PAL_ERRORS_DETAILS, errorCodeToMsgMap);
