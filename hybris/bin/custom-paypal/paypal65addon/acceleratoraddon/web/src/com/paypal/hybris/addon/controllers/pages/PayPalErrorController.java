...
public class PayPalErrorController extends AbstractCheckoutStepController {
                                    ...
                                    final RedirectAttributes redirectAttributes) throws CMSItemNotFoundException
    {
        final Map<String, String> errorsDetails = getSessionService()
                .getAttribute(Paypal65addonControllerConstants.PAY_PAL_ERRORS_DETAILS);
        ...
        return Paypal65addonControllerConstants.Views.Pages.MultiStepCheckout.PayPalHostedOrderPageErrorPage;
    }
