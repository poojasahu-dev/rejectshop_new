        ...
        <table id="config">
            ...
            <tr>
               <td width="25%">Cart Button Config</td>
                <td>
                    <form action="/hac/paypalb2bhac/button/config/cart" method="GET">
            ...
            <tr>
                ...
                <td>
                    <form action="/hac/paypalb2bhac/button/config/minicart" method="GET">
            ...
            <tr>
                ...
                <td>
                    <form action="/hac/paypalb2bhac/button/config/mark" method="GET">
