...
public class PayPalTransactionSearchWidgetRenderer extends AbstractSearcherWidgetRenderer
{
	...
	private void addSelectOrderButton(final ListboxWidget widget, final DataObject metaItem, final Listitem row)
	{
		...
		createAndAttachCustomButton(widget, row, "selectBtn", "btngreen", selectItemEventListener, order);
	}

	private void createAndAttachCustomButton(final ListboxWidget widget, final Listitem parent, final String lable,
