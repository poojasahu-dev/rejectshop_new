...
public class PayPalTransactionSearchService extends AbstractCsSearchService implements CsSearchService
{
			...
			throws SearchException
	{
		...
		final TransactionSearchRequestType request = (TransactionSearchRequestType) getTransactionSearchConverter()
				.convert(requestData);
		final TransactionSearchResponseType response = getPaypalPaymentIntegrationService().transactionSearch(request);
		final TransactionSearchResultData resultData = (TransactionSearchResultData) getTransactionSearchRevertConverter()
				.convert(response);
