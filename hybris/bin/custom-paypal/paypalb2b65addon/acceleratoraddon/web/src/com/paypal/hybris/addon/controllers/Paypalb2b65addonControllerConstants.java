...
/**
 */
public interface Paypalb2b65addonControllerConstants
{
	final String ADDON_PREFIX = "addon:/paypalb2b65addon/";
	...
	interface Actions
	{
		interface Cms
		{
			...
			String PayPalB2bECMiniCartComponent = _Prefix + PayPalB2bECMiniCartComponentModel._TYPECODE + _Suffix;
