...
public class PayPalB2bErrorController extends AbstractCheckoutStepController {
    ...
    @RequestMapping(value = "/paypal/b2b/hop/error", method = RequestMethod.GET)
                                    ...
                                    final RedirectAttributes redirectAttributes) throws CMSItemNotFoundException
    {
        final Map<String, String> errorsDetails = getSessionService()
                .getAttribute(Paypalb2b65addonControllerConstants.PAY_PAL_ERRORS_DETAILS);
        ...
        return Paypalb2b65addonControllerConstants.Views.Pages.MultiStepCheckout.PayPalHostedOrderPageErrorPage;
    }

    @RequestMapping(value = "/paypal/b2b/replenishment/error", method = RequestMethod.GET)
