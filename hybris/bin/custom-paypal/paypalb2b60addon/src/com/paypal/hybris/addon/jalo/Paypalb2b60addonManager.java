...
/**
 * This is the extension manager of the Paypalb2b60addon extension.
 */
public class Paypalb2b60addonManager extends GeneratedPaypalb2b60addonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Paypalb2b60addonManager.class.getName());
	 ...
	 */
	public static Paypalb2b60addonManager getInstance()
	{
		return (Paypalb2b60addonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Paypalb2b60addonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Paypalb2b60addonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Paypalb2b60addonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Paypalb2b60addonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Paypalb2b60addonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
