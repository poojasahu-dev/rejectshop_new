...
"addToCartLayer":"<spring:escapeBody javaScriptEscape="true">
	...
	<ycommerce:testId code="addToCartPopup">
		...
		<div id="addToCartLayer" class="add-to-cart">
            ...
            <div>
                <div class="cartPopupButtons btn btn-block add-to-cart-button">
                    <c:if test="${not empty payPalB2bECButtonComponent}">
                        <cms:component component="${payPalB2bECButtonComponent}" evaluateRestriction="true"/>
                    </c:if>
                </div>
            </div>
