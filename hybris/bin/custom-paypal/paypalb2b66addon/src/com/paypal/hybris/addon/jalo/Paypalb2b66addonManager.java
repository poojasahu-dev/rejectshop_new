...
/**
 * This is the extension manager of the Paypalb2b66addon extension.
 */
public class Paypalb2b66addonManager extends GeneratedPaypalb2b66addonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Paypalb2b66addonManager.class.getName());
	 ...
	 */
	public static Paypalb2b66addonManager getInstance()
	{
		return (Paypalb2b66addonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Paypalb2b66addonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Paypalb2b66addonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Paypalb2b66addonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Paypalb2b66addonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Paypalb2b66addonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
